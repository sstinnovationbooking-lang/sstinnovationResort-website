...
import { ResortArticlesPage } from "@/components/resort-articles-page";
...
export default async function TenantArticlesPage({ params }: PageProps) {
  ...
  return <ResortArticlesPage home={homeData} navbar={homeData.ui?.navbar} />;
}
