...
import { ResortCampingPage } from "@/components/resort-camping-page";
...
export default async function TenantCampingPage({ params }: PageProps) {
  ...
  return <ResortCampingPage home={homeData} navbar={homeData.ui?.navbar} />;
}
